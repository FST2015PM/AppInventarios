...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PueblosMagicos.Android.Inventario.ImageAdapter, PueblosMagicos.Android.Inventario, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ImageAdapter.class, __md_methods);
	}
	...
	public ImageAdapter () throws java.lang.Throwable
	{
		...
		if (getClass () == ImageAdapter.class)
			mono.android.TypeManager.Activate ("PueblosMagicos.Android.Inventario.ImageAdapter, PueblosMagicos.Android.Inventario, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
	...
	public ImageAdapter (android.content.Context p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == ImageAdapter.class)
			mono.android.TypeManager.Activate ("PueblosMagicos.Android.Inventario.ImageAdapter, PueblosMagicos.Android.Inventario, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}

...
{
    [Activity(Label = "Mapa-Wifi", ParentActivity = typeof(SeleccionarModuloActivity))]
    public class WifisActivity : Activity, IOnMapReadyCallback
    {
        private ImageButton tab1Button, tab2Button;
        private ImageButton btnInicio; //
        private Button WifiMapaPopupBtn, WifiMapaSigBtn;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            WifiMapaPopupBtn = FindViewById<Button>(Resource.Id.WifiMapaPopupBtn);
            WifiMapaSigBtn = FindViewById<Button>(Resource.Id.WifiMapaSigBtn);
           ...
           WifiMapaSigBtn.Click += showTab2;
           WifiMapaSigBtn.Visibility = ViewStates.Gone;
           WifiMapaPopupBtn.Click += delegate
            {
               WifiMapaPopupBtn.Visibility = ViewStates.Gone;
               WifiMapaSigBtn.Visibility = ViewStates.Visible;
            };
        ...
        private bool SetupMapIfNeeded()
        {
            if (_map != null)
            {
                ...
                clientLocation = new LatLng(GlobalVariables.LatitudWifi, GlobalVariables.LongitudWifi);
                var marker = new MarkerOptions().SetPosition(clientLocation).Draggable(true);
                _map.AddMarker(marker);
                _map.MarkerDragEnd += (s, e) =>
                {
                    GlobalVariables.LatitudWifi = e.Marker.Position.Latitude;
                    GlobalVariables.LongitudWifi = e.Marker.Position.Longitude;
                };
        ...
        private void InitMapFragment()
        {
            ...
            if (_mapFragment == null)
            {
                ...
                fragTx.Add(Resource.Id.mapWifi, _mapFragment, "map");
                fragTx.Commit();
            }
        ...
        void showTab2(object sender, EventArgs e)
        {
          ...
          StartActivity(typeof(WifisTextosActivity));
        }
